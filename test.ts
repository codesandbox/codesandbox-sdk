...
console.log(await client.fs.rename("/workspace/newdir/text.txt", "/workspace/newdir/renamed.txt"));

console.log("Reading directory after rename file...");
console.log(await client.fs.readdir("/workspace/newdir"));
