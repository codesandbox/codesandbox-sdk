...
import type {
  ...
  SystemUpdateError,
  SystemHibernateData,
  SystemHibernateResponse,
  SystemHibernateError,
  SystemMetricsData,
 ...
 */
export const systemHibernate = <ThrowOnError extends boolean = false>(
  options: Options<SystemHibernateData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    SystemHibernateResponse,
    SystemHibernateError,
 ...
 */
export const systemMetrics = <ThrowOnError extends boolean = false>(
  options: Options<SystemMetricsData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    SystemMetricsResponse,
    SystemMetricsError,
