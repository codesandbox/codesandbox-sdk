...
import type {
  ...
  PreviewTokenRevokeAllData,
  PreviewTokenRevokeAllResponse2,
  PreviewTokenListData,
  PreviewTokenListResponse2,
  PreviewTokenCreateData,
  PreviewTokenCreateResponse2,
  PreviewTokenUpdateData,
  PreviewTokenUpdateResponse2,
  TemplatesCreateData,
  ...
  VmStartResponse2,
  VmUpdateSpecs2Data,
  VmUpdateSpecs2Response,
  PreviewHostListData,
  PreviewHostListResponse2,
  PreviewHostCreateData,
  PreviewHostCreateResponse,
  PreviewHostUpdateData,
  PreviewHostUpdateResponse,
} from "./types.gen";
...
export const metaInfo = <ThrowOnError extends boolean = false>(
  options?: Options<MetaInfoData, ThrowOnError>
) => {
...
export const workspaceCreate = <ThrowOnError extends boolean = false>(
  options?: Options<WorkspaceCreateData, ThrowOnError>
) => {
...
export const tokenUpdate = <ThrowOnError extends boolean = false>(
  options: Options<TokenUpdateData, ThrowOnError>
) => {
...
export const sandboxList = <ThrowOnError extends boolean = false>(
  options?: Options<SandboxListData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).get<
    SandboxListResponse2,
    unknown,
...
export const sandboxCreate = <ThrowOnError extends boolean = false>(
  options?: Options<SandboxCreateData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).post<
    SandboxCreateResponse2,
    unknown,
...
export const sandboxFork = <ThrowOnError extends boolean = false>(
  options: Options<SandboxForkData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    SandboxForkResponse2,
    unknown,
 ...
 *
 */
export const previewTokenRevokeAll = <ThrowOnError extends boolean = false>(
  options: Options<PreviewTokenRevokeAllData, ThrowOnError>
) => {
 ...
 *
 */
export const previewTokenList = <ThrowOnError extends boolean = false>(
  options: Options<PreviewTokenListData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).get<
    PreviewTokenListResponse2,
    unknown,
 ...
 *
 */
export const previewTokenCreate = <ThrowOnError extends boolean = false>(
  options: Options<PreviewTokenCreateData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    PreviewTokenCreateResponse2,
    unknown,
 ...
 *
 */
export const previewTokenUpdate = <ThrowOnError extends boolean = false>(
  options: Options<PreviewTokenUpdateData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).patch<
    PreviewTokenUpdateResponse2,
    unknown,
 ...
 *
 */
export const templatesCreate = <ThrowOnError extends boolean = false>(
  options?: Options<TemplatesCreateData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).post<
    TemplatesCreateResponse,
    unknown,
 ...
 *
 */
export const vmAssignTagAlias = <ThrowOnError extends boolean = false>(
  options: Options<VmAssignTagAliasData, ThrowOnError>
) => {
 ...
 *
 */
export const vmListClusters = <ThrowOnError extends boolean = false>(
  options?: Options<VmListClustersData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).get<
    VmListClustersResponse2,
    unknown,
 ...
 *
 */
export const vmListRunningVms = <ThrowOnError extends boolean = false>(
  options?: Options<VmListRunningVmsData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).get<
    VmListRunningVmsResponse2,
    unknown,
 ...
 *
 */
export const vmCreateTag = <ThrowOnError extends boolean = false>(
  options?: Options<VmCreateTagData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).post<
    VmCreateTagResponse2,
    unknown,
...
export const vmHibernate = <ThrowOnError extends boolean = false>(
  options: Options<VmHibernateData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    VmHibernateResponse2,
    unknown,
 ...
 *
 */
export const vmUpdateHibernationTimeout = <
  ThrowOnError extends boolean = false
>(
  options: Options<VmUpdateHibernationTimeoutData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).put<
    VmUpdateHibernationTimeoutResponse2,
    unknown,
 ...
 *
 */
export const vmCreateSession = <ThrowOnError extends boolean = false>(
  options: Options<VmCreateSessionData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    VmCreateSessionResponse2,
    unknown,
...
export const vmUpdateSpecs = <ThrowOnError extends boolean = false>(
  options: Options<VmUpdateSpecsData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).put<
    VmUpdateSpecsResponse2,
    unknown,
 ...
 *
 */
export const vmUpdateSpecs2 = <ThrowOnError extends boolean = false>(
  options: Options<VmUpdateSpecs2Data, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    VmUpdateSpecs2Response,
    unknown,
 ...
 *
 */
export const previewHostList = <ThrowOnError extends boolean = false>(
  options?: Options<PreviewHostListData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).get<
    PreviewHostListResponse2,
    unknown,
 ...
 *
 */
export const previewHostCreate = <ThrowOnError extends boolean = false>(
  options?: Options<PreviewHostCreateData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).post<
    PreviewHostCreateResponse,
    unknown,
 ...
 *
 */
export const previewHostUpdate = <ThrowOnError extends boolean = false>(
  options?: Options<PreviewHostUpdateData, ThrowOnError>
) => {
  return (options?.client ?? _heyApiClient).put<
    PreviewHostUpdateResponse,
    unknown,
