...
describe("Sandbox Filesystem", () => {
  ...
  describe("File operations", () => {
    ...
    it("should list files in directory", async () => {
      ...
      const testFile = files.find(
        (f) => f.name === "test-file.txt" && f.type === "file"
      );
    ...
    it("should delete a file", async () => {
      ...
      const testFile = filesAfterDeletion.find(
        (f) => f.name === "test-file.txt"
      );
  ...
  describe("Directory operations", () => {
    it("should create a directory", async () => {
      ...
      const testDir = dirs.find(
        (d) => d.name === "test-dir" && d.type === "directory"
      );
  ...
  describe.skip("Batch write operations", () => {
    ...
    it("should write nested directories in batch", async () => {
      ...
      const content1 = await client.fs.readTextFile(
        "/batch-nested/dir1/file.txt"
      );
      const content2 = await client.fs.readTextFile(
        "/batch-nested/dir2/file.txt"
      );
  ...
  describe("Recursive operations", () => {
    ...
    it("should remove directory with contents recursively", async () => {
      ...
      await client.fs.writeTextFile(
        "/recursive-remove/subdir/file2.txt",
        "content"
      );
